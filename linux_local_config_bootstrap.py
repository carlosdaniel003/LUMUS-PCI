...
def preparar_configuracao_local_linux(
    ...
    *,
    ...
    # A primeira execução migra a configuração atual do checkout. Depois disso,
    # a cópia é somente de arquivos ausentes: uma atualização Git jamais pode
    # substituir a geometria já corrigida no JIG.
