...
class FakeAreaApp(AreaRoiEditorV2Mixin, FakeBaseApp):
    pass


class AreaRoiEditorTests(unittest.TestCase):
    ...
    def test_seletor_exige_roi_totalmente_englobada(self):
        leds = [
    ...
    def test_arrasto_no_vazio_seleciona_subconjunto_e_atualiza_preview(self):
        app = FakeAreaApp()
        ...
        self.assertGreaterEqual(len(app.view.preview_calls), 2)
        self.assertEqual((230, 130), app.view.preview_calls[-1])

    def test_clique_curto_no_vazio_continua_criando_roi(self):
        app = FakeAreaApp()
    ...
    def test_arrastar_roi_selecionada_move_apenas_o_subconjunto(self):
        app = FakeAreaApp()
        self.selecionar_duas_primeiras(app)

        app.evento_clique_esquerdo(FakeEvent(100, 100))
        app._evento_arrastar_roi(FakeEvent(120, 120))
        app._evento_soltar_roi(FakeEvent(120, 120))
    ...
    def test_alca_lateral_estica_sem_alterar_raios(self):
        app = FakeAreaApp()
        self.selecionar_duas_primeiras(app)
        ...
        self.assertEqual(10, por_id["LED_002"].raio)
        self.assertEqual((320, 220), (
            por_id["LED_003"].centro_x,
            por_id["LED_003"].centro_y,
        ))

    def test_canto_aumenta_posicoes_e_raios_proporcionalmente(self):
    ...
    def test_delete_remove_somente_as_rois_englobadas(self):
        app = FakeAreaApp()
        self.selecionar_duas_primeiras(app)
